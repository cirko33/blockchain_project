...
function createOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${ca_port} --caname ca-${org_name} -M ${org_path}/peers/peer0.${org_name}.example.com/msp --csr.hosts peer0.${org_name}.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/${org_name}/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${org_path}/msp/config.yaml ${org_path}/peers/peer0.${org_name}.example.com/msp/config.yaml

  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${ca_port} --caname ca-${org_name} -M ${org_path}/peers/peer0.${org_name}.example.com/tls --enrollment.profile tls --csr.hosts peer0.${org_name}.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/${org_name}/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${org_path}/peers/peer0.${org_name}.example.com/tls/tlscacerts/* ${org_path}/peers/peer0.${org_name}.example.com/tls/ca.crt
  cp ${org_path}/peers/peer0.${org_name}.example.com/tls/signcerts/* ${org_path}/peers/peer0.${org_name}.example.com/tls/server.crt
  cp ${org_path}/peers/peer0.${org_name}.example.com/tls/keystore/* ${org_path}/peers/peer0.${org_name}.example.com/tls/server.key

  mkdir -p ${org_path}/msp/tlscacerts
  cp ${org_path}/peers/peer0.${org_name}.example.com/tls/tlscacerts/* ${org_path}/msp/tlscacerts/ca.crt

  mkdir -p ${org_path}/tlsca
  cp ${org_path}/peers/peer0.${org_name}.example.com/tls/tlscacerts/* ${org_path}/tlsca/tlsca.${org_name}.example.com-cert.pem

  mkdir -p ${org_path}/ca
  cp ${org_path}/peers/peer0.${org_name}.example.com/msp/cacerts/* ${org_path}/ca/ca.${org_name}.example.com-cert.pem
...
#   set -x
#   fabric-ca-client enroll -u https://admin:adminpw@localhost:${CA_PORT} --caname ca-org1 --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
#   { set +x; } 2>/dev/null

#   echo 'NodeOUs:
#   Enable: true
#   ClientOUIdentifier:
#     Certificate: cacerts/localhost-${CA_PORT}-ca-org1.pem
#     OrganizationalUnitIdentifier: client
#   PeerOUIdentifier:
#     Certificate: cacerts/localhost-${CA_PORT}-ca-org1.pem
#     OrganizationalUnitIdentifier: peer
...
#   infoln "Generating the peer0 msp"
#   set -x
#   fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${CA_PORT} --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp --csr.hosts peer0.org1.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
#   { set +x; } 2>/dev/null
...
#   infoln "Generating the peer0-tls certificates"
#   set -x
#   fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${CA_PORT} --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls --enrollment.profile tls --csr.hosts peer0.org1.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
#   { set +x; } 2>/dev/null
...
#   infoln "Generating the user msp"
#   set -x
#   fabric-ca-client enroll -u https://user1:user1pw@localhost:${CA_PORT} --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
#   { set +x; } 2>/dev/null
...
#   infoln "Generating the org admin msp"
#   set -x
#   fabric-ca-client enroll -u https://org1admin:org1adminpw@localhost:${CA_PORT} --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
#   { set +x; } 2>/dev/null
